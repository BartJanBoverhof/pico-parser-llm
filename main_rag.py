...
# Process HTA submissions
print("\n--- Extracting HTA Submission PICOs ---")
extracted_picos_hta = rag.extract_picos_hta(countries=COUNTRIES)

# Process clinical guidelines
print("\n--- Extracting Clinical Guideline PICOs ---")
...
print("✓ PICO extraction completed for both source types")
print(f"✓ Results saved to JSON files in 'results' directory")
print(f"✓ HTA submissions: {len(extracted_picos_hta)} countries processed")
print(f"✓ Clinical guidelines: {len(extracted_picos_clinical)} countries processed")
