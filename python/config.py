# ============================
# RAG Pipeline Configuration v1.4 (split retrieval queries and split extraction prompts)
# ============================
# Goals:
# - Separate retrieval for Population & Comparator vs Outcomes
# - Separate extraction for Population & Comparator vs Outcomes
...
SOURCE_TYPE_CONFIGS = {
    "hta_submission": {
        ...
        # Legacy user prompt template (kept for backward compatibility)
